...
const SignIn: FC = (): ReactElement => {
  ...
  const login_status = useSelector(
    (state: RootState) => state.auth.login_status
  );
  ...
  useEffect(() => {
    if (qrScan) {
      ...
      setGoogle2faSecret(
        qrScan.google2fa_secret ? qrScan.google2fa_secret : ""
      );
    }
  }, [qrScan]);
      ...
      {loginStatus == "QRSCAN" && (
        <>
          <Box sx={{ textAlign: "center" }}>
            <Typography sx={{ color: ThemeColor.main }} variant="h6">
              QRコードをスキャンしてください。
            </Typography>
            <Box>
              ...
              >
                {(formikProps: FormikProps<valuesOTP>) => (
                  <Form>
                    ...
                    >
                      <Typography sx={{ mb: 1, ml: 1 }} variant="h6">
                        認証アプリで生成された OTP を入力してください。 30
                        秒ごとに更新されるため、必ず現在のものを送信してください。
                      </Typography>
                      ...
                      <Accordion>
                        ...
                        <AccordionDetails>
                          <Box sx={{ textAlign: "center" }}>
                            <img
                              src={`${serverUrl}upload/qrcodes/${qrCodeUrl}`}
                              alt=""
                            />
                          </Box>
                        </AccordionDetails>
